...
// MARK:- Gateway Environment
public enum BPEnvironment {
    case Live // To proceed on ***> Live / Release / Production <*** environment
    
    case Test // To proceed on ***> Test / Debug <*** environment
}



// MARK:- Mode Of Payment
public enum BPPaymentMode {
...
public protocol BhartiPayDelegate: class {
